...
import { RequestTypes, LocaleTypes, IntentTypes } from "@/lib/constants";
 ...
 * @param options
 */
export function RequestWithType(options: { type: RequestTypes; locale: LocaleTypes }) {
 ...
 * @param options
 */
export function RequestWithIntent(options: { name: IntentTypes; locale: LocaleTypes }) {
